    ...
    <div className="  ">
      ...
      <div className="flex flex-row space-x-10 justify-center">
        <div className="graph-container">
          ...
          <h4 className="">Server 1 Utilization</h4>
          <PieChart width={600} height={400}>
            <Pie
              data={[
                {
                  name: "Utilization",
                  value: serverUtilizationData1.utilization,
                  fill: "#82ca9d",
                },
                {
                  name: "Idle Time",
                  value: serverUtilizationData1.idleTime,
                  fill: "#FF0000",
                },
              ]}
              dataKey="value"
        ...
        <div className="graph-container">
          ...
          <h4 className="">Server 2 Utilization</h4>
          <PieChart width={600} height={400}>
            <Pie
              data={[
                {
                  name: "Utilization",
                  value: serverUtilizationData2.utilization,
                  fill: "#82ca9d",
                },
                {
                  name: "Idle Time",
                  value: serverUtilizationData2.idleTime,
                  fill: "#FF0000",
                },
              ]}
              dataKey="value"
